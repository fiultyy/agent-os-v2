...
podman run -d --name "$CONTAINER" \
  ...
  -e MEMORY_IDLE_THRESHOLD=${MEMORY_IDLE_THRESHOLD:-60} \
  -e MEMORY_IDLE_CONSOLIDATE_THRESHOLD=${MEMORY_IDLE_CONSOLIDATE_THRESHOLD:-300} \
  -e MEMORY_IDLE_EXTRACT_INTERVAL=${MEMORY_IDLE_EXTRACT_INTERVAL:-300} \
